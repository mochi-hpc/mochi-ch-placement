...
static struct placement_mod* placement_mod_xor(int n_svrs, int virt_factor, int seed);
...
struct placement_mod* placement_mod_xor(int n_svrs, int virt_factor, int seed)
{
