...
static struct placement_mod* placement_mod_ring(int n_svrs, int virt_factor, int seed);
...
struct placement_mod* placement_mod_ring(int n_svrs, int virt_factor, int seed)
{
