...
static struct placement_mod* placement_mod_two_d(int n_svrs, int virt_factor, int seed);
...
struct placement_mod* placement_mod_two_d(int n_svrs, int virt_factor, int seed)
{
